...
<body>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <input type="number" name="total_harga" id="total_harga" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
        </div>
